...
(** Score: 6/10
  6.1: 6/5  (Gave one bonus point here, see comment below)
  6.2: Missing
*)
...
(** This detour looks very work-intensive. Perhaps better invest the time on 6.2 ? 
  However, as you successfully handled a quite complex proof architecture, 
  you'll get one bonus point anyway ;)
 **)
