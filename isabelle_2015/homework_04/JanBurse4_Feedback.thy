...
(** Make it a by (induction ...) auto, and it's perfect Isar ;) **)
...
(** Perhaps you should have followed the hint in the assignment,
  and tried to show S\<rightarrow>SS and T\<rightarrow>TT first?
**)
