...
(** Score: 9/10
  ...
  One off b/c informal proof:
    Make clear: On what you do induction. 
    What you have to show, and what the assumptions are in each step!

  1.1:
  Nice trip through definition of  add,mul,pow in peano arithmetic.
  However, using Isabelle's pre-defined functions +,* would have been enough
  for this homework ;)
*)
